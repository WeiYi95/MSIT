...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        predict_file = "./tfdata/train.tf_record"
        choose = input("Choose a test set: ")
        if choose == "small":
            predict_file = "./tfdata/test_small.tf_record"
        elif choose == "big":
            predict_file = "./tfdata/test_big.tf_record"
        #pred_file_name = input("输入预测数据：")
        #predict_file = pred_file_name
